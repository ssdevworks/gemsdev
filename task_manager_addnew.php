		...
		<div class="container">
			<div class="content-container">
				<div class="profile-top-container">
					<div class="span6"><div class="prof-name"><a href="" class="back-arw">Back</a><span>Task Manager<font style="color: red;"><?php echo $checkErr;?></font></span></div></div>
					<div class="span6">
						<input type="button" class="grey-btn" value="Email" />
					</div>
				</div>
				<div class="clr"></div>
				<form method="post" action="task_manager_addnew.php" name="taskform">
					...
					<div class="btns-block">
						...
						<?php if($taskId  >0) {?>
						<input type="submit" class="grey-btn" name="submit" value="Update Task" />
						<?php } else{?>
							<input type="submit" class="grey-btn" name="submit" value="Add Task" />
						<?php }?>
						<input type="button" class="grey-btn" value="Export" />
					</div>
				</form>
			</div>
		</div>
